...
if [[ "$PLATFORM_NAME" == "mac" ]]; then
  ...
  symlink_dotfile ~/.dotfiles/config/vscode/keybindings.json ~/Library/Application\ Support/Code/User/keybindings.json
  ...
  symlink_dotfile ~/.dotfiles/config/vscode/keybindings.json ~/.config/Code/User/keybindings.json
